...
-- 5. SPIN BOT
local SpinBtn=C("TextButton",{Size=UDim2.new(0.98,0,0,40),Text="BẬT XOAY",TextColor3=Color3.fromRGB(255,70,70),TextSize=15,Font=4,BackgroundColor3=Color3.fromRGB(35,35,42)},P1) C("UICorner",{CornerRadius=UDim.new(0,10)},SpinBtn)
local SpinBox=C("TextBox",{Size=UDim2.new(0.98,0,0,35),Text="100",PlaceholderText="Tốc độ xoay (1-10000)",TextColor3=Color3.fromRGB(0,210,255),TextSize=15,Font=4,BackgroundColor3=Color3.fromRGB(20,20,28)},P1) C("UICorner",{CornerRadius=UDim.new(0,8)},SpinBox) C("UIStroke",{Color=Color3.fromRGB(0,170,255),Thickness=1},SpinBox)
...
-- TROLL PLAYER 🤫 (HỆ THỐNG MENU TROLL TRONG TAB FLY & TP)
local TrollTogFrame=C("Frame",{Size=UDim2.new(0.98,0,0,40),BackgroundColor3=Color3.fromRGB(35,35,42)},P2) C("UICorner",{CornerRadius=UDim.new(0,10)},TrollTogFrame)
...
local TrollSwBG=C("Frame",{Size=UDim2.new(0,50,0,24),Position=UDim2.new(1,-60,0.5,-12),BackgroundColor3=Color3.fromRGB(60,60,65)},TrollTogFrame) C("UICorner",{CornerRadius=UDim.new(1,0)},TrollSwBG)
local TrollSwCircle=C("Frame",{Size=UDim2.new(0,20,0,20),Position=UDim2.new(0,2,0.5,-10),BackgroundColor3=Color3.fromRGB(200,200,200)},TrollSwBG) C("UICorner",{CornerRadius=UDim.new(1,0)},TrollSwCircle)
...
C("UICorner",{CornerRadius=UDim.new(0,10)},trollMainFrame) C("UIStroke",{Color=Color3.fromRGB(255,80,80),Thickness=1.5},trollMainFrame) drag(trollMainFrame)
...
local trollListLayout=C("UIListLayout",{SortOrder=Enum.SortOrder.LayoutOrder,Padding=UDim.new(0,4)},trollScrollList)
...
local function startTroll(plr)
	...
	trollConnection=RS.RenderStepped:Connect(function(dt)
		if not isTrolling or not trollTargetPlayer or not trollTargetPlayer.Character then
			stopTroll()
			return
		end
		local myChar=LocalPlayer.Character
		local targetChar=trollTargetPlayer.Character
		local myHrp=myChar and myChar:FindFirstChild("HumanoidRootPart")
		...
		if myHrp and targetHrp and targetHumanoid then
			...
			myHrp.CFrame=targetHrp.CFrame*CFrame.new(0,0,distanceOffset)
		end
	end)
end
...
LP.PlayerAdded:Connect(function(plr) refreshPlayerList() updateTrollPlayerList() end)
